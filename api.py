...
def create_app(test_config=None):
    ...
    def get_actors(payload):
        data = []
        # get all actors usig the query method
    ...
    def get_movies(payload):
        data = []
        # get all movies using the query method
    ...
    def create_actor(payload):
        data = []
        body = request.get_json()
        # check if any of the fileds is missing on the request body and abort
        if 'name' not in body:
        ...
        # Check if any of the fileds is null and return appropiate error
        if name is None:
